...
#ifndef M2KCALIBRATION_FAKE_IMPL_HPP
#define M2KCALIBRATION_FAKE_IMPL_HPP
...
class M2kFakeCalibrationImpl : public M2kCalibration
{
public:
	M2kFakeCalibrationImpl(struct iio_context* ctx, libm2k::analog::M2kAnalogIn* analogIn,
		       libm2k::analog::M2kAnalogOut* analogOut);
	virtual ~M2kFakeCalibrationImpl();
...
private:
	...
	libm2k::analog::M2kFakeAnalogInImpl* m_m2k_adc;
	libm2k::analog::M2kFakeAnalogOutImpl* m_m2k_dac;
