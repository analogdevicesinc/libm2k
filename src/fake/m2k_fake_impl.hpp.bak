...
#ifndef M2K_FAKE_IMPL_H
#define M2K_FAKE_IMPL_H
...
namespace context {
class M2kFakeImpl : public M2k, public ContextImpl
{
public:
	M2kFakeImpl(std::string uri, iio_context* ctx, std::string name, bool sync);
