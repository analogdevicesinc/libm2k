...
#include <cmath>
#include "m2kpowersupply_fake_impl.hpp"
...
M2kFakePowerSupplyImpl::M2kFakePowerSupplyImpl(iio_context *ctx, std::string write_dev,
...
M2kFakePowerSupplyImpl::~M2kFakePowerSupplyImpl()
{

}

void M2kFakePowerSupplyImpl::syncDevice()
{
...
void M2kFakePowerSupplyImpl::reset()
{
	powerDownDacs(true);
...
void M2kFakePowerSupplyImpl::powerDownDacs(bool powerdown)
{
...
void M2kFakePowerSupplyImpl::enableChannel(unsigned int chnIdx, bool en)
{
...
bool M2kFakePowerSupplyImpl::anyChannelEnabled()
{
...
void M2kFakePowerSupplyImpl::loadCalibrationCoefficients()
{
...
double M2kFakePowerSupplyImpl::getCalibrationCoefficient(std::string key)
{
...
void M2kFakePowerSupplyImpl::enableAll(bool en)
{

}

double M2kFakePowerSupplyImpl::readChannel(unsigned int idx)
{
	double val = 0;
	double offset = 0;
	double gain = 0;
...
void M2kFakePowerSupplyImpl::pushChannel(unsigned int chnIdx, double value)
{
	double offset = 0;
	double gain = 0;
	double val;
