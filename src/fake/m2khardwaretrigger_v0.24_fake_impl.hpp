...
#ifndef M2KHARDWARETRIGGER_FAKE_IMPL_v024_HPP
#define M2KHARDWARETRIGGER_FAKE_IMPL_v024_HPP
...
namespace libm2k {
class M2kFakeHardwareTriggerV024Impl : public M2kFakeHardwareTriggerImpl
{
public:
	M2kFakeHardwareTriggerV024Impl(struct iio_context *ctx, bool init = true);
	virtual ~M2kFakeHardwareTriggerV024Impl();
