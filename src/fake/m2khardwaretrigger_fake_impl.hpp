...
#ifndef M2KHARDWARETRIGGER_FAKE_IMPL_HPP
#define M2KHARDWARETRIGGER_FAKE_IMPL_HPP
...
namespace libm2k {
class M2kFakeHardwareTriggerImpl : public M2kHardwareTrigger
{
public:
	M2kFakeHardwareTriggerImpl(struct iio_context *ctx, bool init = true);

	virtual ~M2kFakeHardwareTriggerImpl();
