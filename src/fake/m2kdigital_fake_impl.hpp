...
#ifndef M2KDIGITAL_FAKE_IMPL_HPP
#define M2KDIGITAL_FAKE_IMPL_HPP
...
namespace digital {
class M2kFakeDigitalImpl : public M2kDigital
{
public:
	M2kFakeDigitalImpl(struct iio_context* ctx, std::string logic_dev, bool sync, M2kHardwareTrigger *trigger);
	virtual ~M2kFakeDigitalImpl();
